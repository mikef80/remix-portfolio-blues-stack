...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create remix-portfolio-blues-stack-fdfa
  fly apps create remix-portfolio-blues-stack-fdfa-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app remix-portfolio-blues-stack-fdfa
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app remix-portfolio-blues-stack-fdfa-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'remix-portfolio-blues-stack-fdfa-staging' does not match app name in config file 'remix-portfolio-blues-stack-fdfa'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name remix-portfolio-blues-stack-fdfa-db
  fly postgres attach --app remix-portfolio-blues-stack-fdfa remix-portfolio-blues-stack-fdfa-db

  fly postgres create --name remix-portfolio-blues-stack-fdfa-staging-db
  fly postgres attach --app remix-portfolio-blues-stack-fdfa-staging remix-portfolio-blues-stack-fdfa-staging-db
  ```
